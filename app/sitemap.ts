...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${base}/umkm/kalkulator-hpp`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/umkm/kalkulator-bep`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/umkm/kalkulator-cicilan`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/umkm/kalkulator-diskon`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/umkm/generator-invoice`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/umkm/generator-kwitansi`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    ...
    {
      url: `${base}/karir/surat-lamaran`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/karir/surat-resign`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    ...
    {
      url: `${base}/karir/perjanjian-kerja`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/karir/surat-pernyataan`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    ...
    {
      url: `${base}/dev/json-formatter`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/dev/jwt-debugger`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${base}/dev/hash-generator`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.8,
    },
